...
// Copyright (c) 2013 Mazacoin developers
...
/** Amount of mazacoins spent by the transaction.
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running MazacoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MazacoinMiner terminated\n");
        throw;
    }
}
